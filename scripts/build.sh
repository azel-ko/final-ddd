...
# 显示构建信息
echo -e "${GREEN}开始构建 Final DDD 应用...${NC}"
...
echo -e "${GREEN}构建完成！生成的二进制文件: final-ddd${NC}"
echo -e "${YELLOW}提示: 使用 './deploy/scripts/build.sh' 构建 Docker 镜像${NC}"